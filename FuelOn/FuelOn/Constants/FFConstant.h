...
#define kKEY_REFERENCE_ID @"referenceId"
...
// ****** On Display & Related Designs API keys ****** //

#define kParamKEY_OnDisplay_Source      @"source"
#define kParamKEY_OnDisplay_UUID        @"deviceId"
//#define kParamKEY_OnDisplay_Source      @"userId"

// Book Service Form
#define kKEY_BookService_name @"BookServiceForm[name]"
#define kKEY_BookService_email @"BookServiceForm[email]"
#define kKEY_BookService_contact @"BookServiceForm[contact_number]"
#define kKEY_BookService_address @"BookServiceForm[address]"
#define kKEY_BookService_type @"BookServiceForm[type]"


//Submit ratings
#define kKEY_RatingForm_name @"RatingForm[name]"
#define kKEY_RatingForm_comment @"RatingForm[comment]"
#define kKEY_RatingForm_rating @"RatingForm[rating]"
#define kKEY_RatingForm_sku @"sku"
#define kKEY_RatingForm_deviceId @"deviceId"
